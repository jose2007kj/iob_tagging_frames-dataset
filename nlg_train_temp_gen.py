						...
						for val in args['args']:
										...
										for anot in ref['annotations']:
											if 'key' in anot and 'val' in anot:
												...
												if type(anot['val'])==str:
													nlg_temp=re.sub(anot['val'],anot['key'], nlg_temp, 1)
												else:
													nlg_temp=re.sub(str(anot['val']),anot['key'], nlg_temp, 1)
							...
							# nlg temp
								...
								if 'val' in val:
									print(val['val'])
									if type(val['val'])==str:
										nlg_temp=re.sub(val['val'],val['key'], nlg_temp, 1)
									else:
										nlg_temp=re.sub(str(val['val']),val['key'], nlg_temp, 1)
